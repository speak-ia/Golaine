      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <a href="#" className="flex items-center gap-2.5">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center bg-gradient-to-br from-[rgb(37,211,102)] to-[rgb(22,163,74)]">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-2.5 mb-5">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-gradient-to-br from-[rgb(37,211,102)] to-[rgb(22,163,74)]">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
