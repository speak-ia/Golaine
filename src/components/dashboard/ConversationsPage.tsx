      ...
      <div className="px-4 pt-4 pb-2">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#25D366]/30 focus:border-[#25D366] transition-all"
          />
        </div>
        ...
        <div className="flex bg-gray-100 rounded-lg p-0.5 mb-2">
          {filterTabs.map((tab) => (
            ...
            >
              {tab.label}
              {tab.key === "active" && (
                <span className="ml-1 text-[10px] bg-[#25D366]/10 text-[#25D366] px-1.5 py-0.5 rounded-full font-semibold">
                  {activeCount}
                </span>
              )}
            </button>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl text-left transition-all cursor-pointer group ${
                  isSelected
                    ? "bg-[#E8F8EF] border-l-[3px] border-[#25D366]"
